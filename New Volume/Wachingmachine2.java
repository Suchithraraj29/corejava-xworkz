...
if(isConnected == false){
	isConnected = true;
	System.out.println("Wachingmachine  is turned onn");
 }
 else if(isConnected == true){
 isConnected = false;
 System.out.println(" Wachingmachine is turned off.. ");
 }
 // return is optional
 return isConnected;
}
...
if(isConnected == true){
	...
	System.out.println(" Wachingmachine not connected");
	}
